...
- Clone this repository: `git clone https://github.com/pandadev666/aws-serverless-example`
- Change to the directory with the repository copy: `cd aws-serverless-example`
